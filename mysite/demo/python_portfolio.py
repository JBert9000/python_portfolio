...
def plot():
    ...
    start=datetime.timedelta(6*365/12)
    ...
    p=figure(x_axis_type='datetime',width=1000,height=300,responsive=True) # can repalce responsive=True with: sizing_mode='scale_width'
